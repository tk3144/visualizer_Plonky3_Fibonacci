...
* [std::fs::File](https://doc.rust-lang.org/std/vec/struct.Vec.html) & [std::io::Write](https://doc.rust-lang.org/std/vec/struct.Vec.html) Filesystem operations, specifically used for creating the output file and writing the JSON byte buffer.
